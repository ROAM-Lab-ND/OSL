...
def accelCal(devId,FX,N=30000,Nvis=15000,run=1):
    ...
    '''
    This function is used to determine the bias of the x-Axis and y-Axis Accelerometer of the Knee actuator
    '''
...
def ankleVertAccelCal(devId,FX,N=30000,Nvis=15000,run=1):
    ...
    NOTE 1: THIS SHOULD BE CALLED IN PLACE OF THE ACCELEROMETER CALIBRATION FUNCTION accelCal
