...
Updates: Updated anklePosMapping to bypass use of ankle encoder data due to concerns with data reading from external encoder. Updated ankleTRMapping to ankleTRMappingAnk with new polyfit coefficients for range of motion [-10 (dorsiflexion), 20 (plantar flexion)]. Created ankleTRMappingMot with new polyfit coefficients for range of motion [-10 (dorsiflexion), 20 (plantar flexion)].
#################################### CLOSE #####################################
'''
...
def anklePosMapping(devId,jointDesDeg,calData):
    ...
    polyCoeff = [6.90400631621864e-06, -0.000144043436547594, 0.002139595852316, -0.010657469264743, 3.42861224487564, -3.00193673363941e-14]
...
def ankleTRMappingAnk(devId,jointAng,calData):
